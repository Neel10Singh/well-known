                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="checkout  box-shadow1">
                             <form  method="post" action="<?php echo base_url('welcome/get_gift_booking_information/') ; ?>" >
                            <div class="billing-fields">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <a class="ttm-btn ttm-btn-size-xs ttm-btn-shape-square ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-skincolor" href="<?php echo base_url('extra-decoration-information') ; ?>" title="">
                                            Back To Page 
                                 ...
                                 <div class="row">
                                            <?php foreach($gift as $key=>$value) {?>
                                                 <div class="col-sm-3 col-6">
                                                      <input type="checkbox" class="btn-check radioBtnClass" name="gift_option[]" id="option<?php echo $value->id; ?>" value="<?php echo $value->id; ?>"  >
                                                      <label class="btn btn-light option_button" for="option<?php echo $value->id; ?>"><?php if(!empty($value->image)){ ?> <img src="<?php echo base_url('uploads/gift/').$value->image; ?>" style="width:100px"><?php } ?> <p><?php echo $value->title; ?> <br> ₹ <?php echo $value->price; ?></p></label>
                                                 </div> 
                                            <?php } ?> 
                                     </div>
                                <div class="row">
...
$(document).on("change", ".radioBtnClass", function () {
    ...
    $.each($(".radioBtnClass:checked"), function (K, V) {    
      ...
      $.ajax({
          type:'POST',
          url:'<?php echo base_url('welcome/get_gift_booking_amount') ?>',
          data: {"gift": fruitArray},
