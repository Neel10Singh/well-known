                    ...
                    <div class="row profile">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-12 sidebar-widget-area">
                                <div class="tab-contents sidebar-widget">
                                    ...
                                    <div class="padding-12 box-shadow" id="History">
                                        <h4 class="widget-title">Add Review</h4>
                                        <h5><a href="<?php echo base_url('package/').$theatre[0]->url_slug ?>"><?php echo $theatre[0]->title; ?></a></h5>
                                        <form method="post">
                                            
                                      
                                        <div class="feedback">
                                            <div class="rating">
                                                <input type="radio" name="rating" value="5" id="rating-5"  <?php if(count($review) > 0 ){ echo ($review[0]->rating == '5')?"checked":"" ; } ?> >
                                                <label for="rating-5"></label>
                                                <input type="radio" name="rating" value="4" id="rating-4"  <?php if(count($review) > 0 ){ echo ($review[0]->rating == '4')?"checked":"" ; } ?> >
                                                <label for="rating-4"></label>
                                                <input type="radio" name="rating" value="3" id="rating-3"  <?php if(count($review) > 0 ){ echo ($review[0]->rating == '3')?"checked":"" ; } ?>  >
                                                <label for="rating-3"></label>
                                                <input type="radio" name="rating" value="2" id="rating-2"  <?php if(count($review) > 0 ){ echo ($review[0]->rating == '2')?"checked":"" ; } ?>  >
                                                <label for="rating-2"></label>
                                                <input type="radio" name="rating" value="1" id="rating-1"  <?php if(count($review) > 0 ){ echo ($review[0]->rating == '1')?"checked":"" ; } ?>  >
                                        ...
                                        <div class="review-option mt-20 mb-20">
                                            <textarea name="comment" required id="" rows="10" placeholder="write a review!!"><?php if(count($review) > 0 ){ echo $review[0]->comment ; } ?> </textarea>
                                        </div>
                                        <button type="submit"  class="ttm-btn ttm-btn-size-md ttm-bttm-btn ttm-btn-size-md ttm-btn-shape-round ttm-btn-style-fill ttm-btn-color-skincolor mt-20tn-shape-round ttm-btn-style-fill ttm-btn-color-skincolor mt-20"> Post</button>
                                      </form>
