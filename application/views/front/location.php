...
<body>
    <div class="page">
            ...
            <div class="title-box text-center">
                <div class="container">
                    <div class="page-title-heading">
                        <h1 class="title"><?php echo count($location) ; ?> in <?php echo $city[0]->title; ?></h1>
                    </div>
                    <br>
        ...
        <div class="site-main">
            <section class="ttm-row team-section ttm-bgcolor-grey clearfix">
                <div class="container">
                    <div class="row pt-20" id="location"> 
                    <?php include('location-view.php') ; ?>
                    </div>
                </div>
            </section>
            <!--event-section end-->
    ...
    $('#datepicker').on('change',function(){
              ...
              if(date){
                  $.ajax({
                      type:'POST',
                      url:'<?php echo base_url('welcome/get_location_of_city_on_date') ?>',
                      data: {"date": date, "city_id": <?php echo $city[0]->id; ?>},
