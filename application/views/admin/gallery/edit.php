...
<head>
    ...
    <title><?php echo $link[0]->title ;  ?> | Edit gallery</title>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url('admin/gallery/listing'); ?>">All gallery</a>
                    </li>
                            ...
                            <form role="form" method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                                <div class="box-body row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select class="form-control" name="service_id" required>
                                           ...
                                           <?php foreach($service as $key=>$value){ ?>
                                            <option value='<?php echo $value->id; ?>' <?php echo($RESULT[0]->service_id==$value->id)?'selected':''; ?>><?php echo $value->title; ?></option>
                                            <?php } ?>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="file" class="form-control" name="image"  id="image" onchange="show_preview();" accept="image/png, image/jpeg,image/png,image/JPEG,image/JPG,image/PNG" >
                                         <div class="" id="image_preview">
                                             <?php if(!empty($RESULT[0]->image)){ ?>
                                            <img src="<?php echo base_url('uploads/gallery/').$RESULT[0]->image; ?>" width="50%">
                                            <?php } ?>
                                         </div>
