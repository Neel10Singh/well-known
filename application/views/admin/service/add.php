                            ...
                            <form role="form" method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                                <div class="box-body row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="file" class="form-control" name="image"  id="image" onchange="show_preview();" required accept="image/png, image/jpeg,image/png,image/JPEG,image/JPG,image/PNG">
                                         <div class="" id="image_preview"></div>
                                         
                                    </div> 
                                    <div class="form-group col-sm-6">
                                        <label for="exampleInputEmail1">Decoartion Icon </label>
                                        <input type="file" class="form-control" name="icon"  id="icon" onchange="show_icon_preview();" required accept="image/png, image/jpeg,image/png,image/JPEG,image/JPG,image/PNG">
                                         <div class="" id="icon_preview"></div>
