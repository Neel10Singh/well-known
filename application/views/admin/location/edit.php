...
<head>
    ...
    <title><?php echo $link[0]->title ;  ?> | Edit location</title>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url('admin/location/listing'); ?>">All location</a>
                    </li>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="file" class="form-control" name="image"  id="image" onchange="show_icon_preview();" accept="image/png, image/jpeg,image/png,image/JPEG,image/JPG,image/PNG" >
                                         <div class="" id="image_preview">
                                            ...
                                            <img src="<?php echo base_url('uploads/location/').$RESULT[0]->image; ?>" width="50%">
                                            <?php } ?>
                                         </div>
