...
<head>
    ...
    <title>
        <?php echo $link[0]->title ; ?> | All Gift</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box-footer">
                <a href="add_new">
                    <button type="submit" class="btn btn-primary" name="submitform">Add New Gift</button>
                </a>
            </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if(!empty($record->image)){ ?> <img src="<?php echo base_url('uploads/gift/').$record->image; ?>" width="50px"><?php } ?>
                                    ...
                                    <td width="15%">
                                        ...
                                        <?php }?> </td>
                                    <td width="15%"> <a href="<?php echo base_url('admin/gift/edit/'.$record->id); ?>" class="btn  btn-success btn-xs"><i class="fa fa-fw fa-edit"></i>Edit</a>
                                    </td>
                                </tr>
                                <?php } ?> </tbody>
                            <?php } ?> </table>
