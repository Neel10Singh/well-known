                                ...
                                <div class="box-body row">
                                     <div class="form-group col-sm-6">
                                       ...
                                       <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control" maxlength="15" minlength="4" name="code" value="<?php echo $RESULT[0]->code; ?>" required placeholder="Enter CODE">
                                        <?php echo form_error( 'code'); ?> </div>
                                    <div class="form-group col-sm-6">
                                        <label for="exampleInputEmail1">Type</label>
                                            <select class="form-control" name="status" required>
                                            <option value='Percentage'  <?php echo($RESULT[0]->status=='Percentage')?'selected':''; ?>>Percentage</option>
                                            <option value='Flat'  <?php echo($RESULT[0]->status=='Flat')?'selected':''; ?>>Flat</option>
                                        </select></div>
                                    <div class="form-group col-sm-6">
