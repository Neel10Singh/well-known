...
<head>
    ...
    <title>
        <?php echo $link[0]->title ; ?> | All cake</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">All cake</li>
                </ol>
            </section>
            <div class="box-footer">
                <a href="add_new">
                    <button type="submit" class="btn btn-primary" name="submitform">Add New cake</button>
                </a>
            </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if(!empty($record->image)){ ?> <img src="<?php echo base_url('uploads/cake/').$record->image; ?>" width="50px"><?php } ?>
                                    ...
                                    <td width="15%">
                                        ...
                                        <?php }?> </td>
                                    <td width="15%"> <a href="<?php echo base_url('admin/cake/edit/'.$record->id); ?>" class="btn  btn-success btn-xs"><i class="fa fa-fw fa-edit"></i>Edit</a>
                                   </td>
                                </tr>
                                <?php } ?> </tbody>
                            <?php } ?> </table>
