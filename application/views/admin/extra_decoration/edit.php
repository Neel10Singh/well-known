...
<head>
    ...
    <title><?php echo $link[0]->title ;  ?> | Edit Extra Decoration</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Edit Extra Decoration</h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url('admin/dashboard'); ?>"><i class="fa fa-dashboard"></i> Home</a>
                    </li>
                    <li><a href="<?php echo base_url('admin/extra_decoration/listing'); ?>">All Extra Decoration</a>
                    </li>
                    <li class="active">Edit Extra Decoration</li>
                </ol>
            </section>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="file" class="form-control" name="image"  id="image" onchange="show_icon_preview();" accept="image/png, image/jpeg,image/png,image/JPEG,image/JPG,image/PNG" >
                                         <div class="" id="image_preview">
                                            ...
                                            <img src="<?php echo base_url('uploads/extra_decoration/').$RESULT[0]->image; ?>" width="50%">
                                            <?php } ?>
                                         </div>
