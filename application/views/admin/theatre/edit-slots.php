...
<head>
    ...
    <title><?php echo $link[0]->title ;  ?>| Edit slots</title>
                            ...
                            <form role="form" method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                                <div class="box-body row">
                                     ...
                                     <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" class="form-control" name="title"  value="<?php echo $slots[0]->title; ?>"  required placeholder="Enter Slots Timing">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select class="form-control" name="status" required>
                                             <option value='1' <?php echo($slots[0]->status==1)?'selected':''; ?> >Active</option>
                                            <option value='0' <?php echo($slots[0]->status==0)?'selected':''; ?>>Inactive</option>
                                        </select>
                                     ...
                                     <div class="form-group col-sm-12 ">
                                         <div class="box box-success box-solid">  
                                               <div class="box-header with-border">Add Disabled Date</div>
                                                <div class="box-body">
                                                    <?php $disabled_dates = explode(',' ,$slots[0]->disabled_dates );?>
                                                    <div class="row">
                                                    <?php foreach($disabled_dates as $key=>$value){ ?>
                                                        <span class="fille_group"><div class="col-md-3"><input type="date" class="form-control" value="<?php echo $value; ?>" name="disabled_dates[]" required></div><div class="col-md-1" style="padding-bottom:5px"><a class="btn btn-danger removedata"><i class="fa fa-fw fa-trash"></i></a></div></span>
                                                    <?php    } ?>
                                                    </div>
                                                    <div  class="row" id="append_diabled_date"></div> <span class="clearfix"></span>
