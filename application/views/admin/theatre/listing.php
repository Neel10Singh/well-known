    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box-footer">
                <a href="add_new">
                    <button type="submit" class="btn btn-primary" name="submitform">Add New Theatre</button>
                </a>
            </div>
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <?php  $count =  count( $this->theatre_model->get_slots_by_theatre_id($record->id));  ;?>
                                <tr>
                                    <td width="7%">
                                        <?php echo $no; ?>
                                    </td>
                                    ...
                                    <td><?php echo $record->location_title; ?></td>
                                    <td><?php if(!empty($record->image)){ ?> <img src="<?php echo base_url('uploads/theatre/').$record->image; ?>" width="150px"><?php } ?>
                                    ...
                                    <td width="15%">
                                        ...
                                        <?php }?> </td>
                                    <td width="15%"> 
                                    <a href="<?php echo base_url('admin/theatre/edit/'.$record->id); ?>" class="btn  btn-success btn-xs"><i class="fa fa-fw fa-edit"></i>Edit</a>
                                    <a href="<?php echo base_url('admin/theatre/slots/'.$record->id); ?>" class="btn  btn-primary btn-xs"><i class="fa fa-fw fa-eye"></i><?php echo $count; ?> Slots</a>
